...
public class RadioNationalTests extends TestBase {
	...
	@Test
	public void navigateToProgramMenuItem() throws InterruptedException {
	...
	@Test
	public void navigateToLastProgramInBanner() throws InterruptedException {
	...
	@Test
	public void searchRN() throws InterruptedException {
	...
	@Test
	public void socialMediaPopUp() throws InterruptedException {
		rnpg = new RadioNationalPage(this.driver);
	...
	@Test
	public void downloadAudio() throws InterruptedException {
		rnpg = new RadioNationalPage(this.driver);		
	...
	@Test
	public void verifyListenNow() throws InterruptedException {
		rnpg = new RadioNationalPage(this.driver);		
	...
	@Test
	public void verifyAudioPlayerInListenNow() throws InterruptedException {
		rnpg = new RadioNationalPage(this.driver);		
